...
# Usage:
# 1) Copy this to somewhere (e.g. ~/.local/share/bash_completion/rns-page-node).
# 2) Add the following line to your .bashrc:
#    source ~/.local/share/bash_completion/rns-page-node
# See also: https://github.com/scop/bash-completion/blob/main/doc/configuration.md



_shtab_rns_page_node_option_strings=(-h --help -c --config -p --pages-dir -f --files-dir -m --media-dir -n --node-name -a --announce-interval -i --identity-dir --page-refresh-interval --file-refresh-interval -l --log-level)



_shtab_rns_page_node__l_choices=(DEBUG INFO WARNING ERROR CRITICAL)
_shtab_rns_page_node___log_level_choices=(DEBUG INFO WARNING ERROR CRITICAL)

_shtab_rns_page_node__h_nargs=0
_shtab_rns_page_node___help_nargs=0
...
_shtab_rns_page_node() {
  ...
  local prefix=_shtab_rns_page_node
  local word_index=0
...
complete -F _shtab_rns_page_node rns-page-node